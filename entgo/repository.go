...
import (
	...
	"github.com/kalandramo/bald-crud/entgo/pagination"
	"github.com/kalandramo/bald-crud/entgo/rule"
	"github.com/kalandramo/bald-crud/entgo/sorting"
	"github.com/kalandramo/bald-crud/entgo/update"
	paginationCurd "github.com/kalandramo/bald-crud/pagination"
...
func (r *Repository[
	...
	builder ListBuilder[ENT_QUERY, ENT_SELECT, ENTITY],
	countBuilder ListBuilder[ENT_QUERY, ENT_SELECT, ENTITY],
	req *storev1.PaginationRequest,
) (*PagingResult[DTO], error) {
	if req == nil {
		return nil, errors.New("storev1 request is nil")
	}
...
func (r *Repository[
	...
	if req == nil {
		return nil, nil, errors.New("storev1 request is nil")
	}
