...
func TestProcessor_ProcessDispatcher(t *testing.T) {
	...
	cases := []struct {
		...
		{storev1.Operator_EQ, "name", "tom", true},
		{storev1.Operator_IN, "name", `["a","b"]`, true},
		{storev1.Operator_BETWEEN, "created_at", `["2020-01-01","2021-01-01"]`, true},
		{storev1.Operator_IS_NULL, "deleted_at", "", true},
		{storev1.Operator_SEARCH, "any", "", true},
	}
