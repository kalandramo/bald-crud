...
func (sf StructuredFilter) BuildSelectors(expr *storev1.FilterExpr) ([]func(s *sql.Selector), error) {
	if expr == nil {
		return nil, nil
	}

	// Skip unspecified expressions
	if expr.GetType() == storev1.ExprType_EXPR_TYPE_UNSPECIFIED {
...
func (sf StructuredFilter) buildFilterSelector(expr *storev1.FilterExpr) (func(s *sql.Selector), error) {
	...
	selector = func(s *sql.Selector) {
		...
		if len(ps) > 0 {
			switch expr.GetType() {
			case storev1.ExprType_AND:
				s.Where(sql.And(ps...))
			case storev1.ExprType_OR:
				s.Where(sql.Or(ps...))
			}
		}
	}
...
func (sf StructuredFilter) processCondition(s *sql.Selector, conditions []*storev1.FilterCondition) ([]*sql.Predicate, error) {
	if len(conditions) == 0 {
		return nil, nil
	}
...
// Process 处理过滤条件
func (sf StructuredFilter) Process(s *sql.Selector, p *sql.Predicate, condition *storev1.FilterCondition) *sql.Predicate {
...
func (sf StructuredFilter) getField(s *sql.Selector, condition *storev1.FilterCondition) string {
	if condition == nil {
		return ""
	}
...
// Equal = 相等操作
// SQL: WHERE "name" = "tom"
func (sf StructuredFilter) Equal(s *sql.Selector, p *sql.Predicate, condition *storev1.FilterCondition) *sql.Predicate {
...
func (sf StructuredFilter) NotEqual(s *sql.Selector, p *sql.Predicate, condition *storev1.FilterCondition) *sql.Predicate {
	return p.Not().EQ(s.C(sf.getField(s, condition)), condition.GetValue())
}

// In IN操作
// SQL: WHERE name IN ("tom", "jimmy")
func (sf StructuredFilter) In(s *sql.Selector, p *sql.Predicate, condition *storev1.FilterCondition) *sql.Predicate {
...
func (sf StructuredFilter) NotIn(s *sql.Selector, p *sql.Predicate, condition *storev1.FilterCondition) *sql.Predicate {
	if len(condition.GetValue()) > 0 {
		var jsonValues []any
		if err := sf.codec.Unmarshal([]byte(condition.GetValue()), &jsonValues); err == nil {
...
func (sf StructuredFilter) GTE(s *sql.Selector, p *sql.Predicate, condition *storev1.FilterCondition) *sql.Predicate {
	return p.GTE(s.C(sf.getField(s, condition)), condition.GetValue())
}

// GT (Greater than) 大于 > 操作
// SQL: WHERE "create_time" > "2023-10-25"
func (sf StructuredFilter) GT(s *sql.Selector, p *sql.Predicate, condition *storev1.FilterCondition) *sql.Predicate {
	return p.GT(s.C(sf.getField(s, condition)), condition.GetValue())
}

// LTE LTE (Less Than or Equal) 小于等于 <=操作
// SQL: WHERE "create_time" <= "2023-10-25"
func (sf StructuredFilter) LTE(s *sql.Selector, p *sql.Predicate, condition *storev1.FilterCondition) *sql.Predicate {
	return p.LTE(s.C(sf.getField(s, condition)), condition.GetValue())
}

// LT (Less than) 小于 <操作
// SQL: WHERE "create_time" < "2023-10-25"
func (sf StructuredFilter) LT(s *sql.Selector, p *sql.Predicate, condition *storev1.FilterCondition) *sql.Predicate {
...
func (sf StructuredFilter) Range(s *sql.Selector, _ *sql.Predicate, condition *storev1.FilterCondition) *sql.Predicate {
	if len(condition.GetValue()) > 0 {
		var jsonValues []any
		if err := sf.codec.Unmarshal([]byte(condition.GetValue()), &jsonValues); err == nil {
			if len(jsonValues) != 2 {
...
func (sf StructuredFilter) IsNull(s *sql.Selector, p *sql.Predicate, condition *storev1.FilterCondition) *sql.Predicate {
	return p.IsNull(s.C(sf.getField(s, condition)))
}

// IsNotNull 不为空 IS NOT NULL操作
// SQL: WHERE name IS NOT NULL
func (sf StructuredFilter) IsNotNull(s *sql.Selector, p *sql.Predicate, condition *storev1.FilterCondition) *sql.Predicate {
	return p.Not().IsNull(s.C(sf.getField(s, condition)))
}

// Contains LIKE 前后模糊查询
// SQL: WHERE name LIKE '%L%';
func (sf StructuredFilter) Contains(s *sql.Selector, p *sql.Predicate, condition *storev1.FilterCondition) *sql.Predicate {
	return p.Contains(s.C(sf.getField(s, condition)), condition.GetValue())
}

// InsensitiveContains ILIKE 前后模糊查询
// SQL: WHERE name ILIKE '%L%';
func (sf StructuredFilter) InsensitiveContains(s *sql.Selector, p *sql.Predicate, condition *storev1.FilterCondition) *sql.Predicate {
	return p.ContainsFold(s.C(sf.getField(s, condition)), condition.GetValue())
}

// StartsWith LIKE 前缀+模糊查询
// SQL: WHERE name LIKE 'La%';
func (sf StructuredFilter) StartsWith(s *sql.Selector, p *sql.Predicate, condition *storev1.FilterCondition) *sql.Predicate {
...
func (sf StructuredFilter) InsensitiveStartsWith(s *sql.Selector, p *sql.Predicate, condition *storev1.FilterCondition) *sql.Predicate {
	return p.EqualFold(s.C(sf.getField(s, condition)), condition.GetValue()+"%")
}

// EndsWith LIKE 后缀+模糊查询
// SQL: WHERE name LIKE '%a';
func (sf StructuredFilter) EndsWith(s *sql.Selector, p *sql.Predicate, condition *storev1.FilterCondition) *sql.Predicate {
	return p.HasSuffix(s.C(sf.getField(s, condition)), condition.GetValue())
}

// InsensitiveEndsWith ILIKE 后缀+模糊查询
// SQL: WHERE name ILIKE '%a';
func (sf StructuredFilter) InsensitiveEndsWith(s *sql.Selector, p *sql.Predicate, condition *storev1.FilterCondition) *sql.Predicate {
	return p.EqualFold(s.C(sf.getField(s, condition)), "%"+condition.GetValue())
}

// Exact LIKE 操作 精确比对
// SQL: WHERE name LIKE 'a';
func (sf StructuredFilter) Exact(s *sql.Selector, p *sql.Predicate, condition *storev1.FilterCondition) *sql.Predicate {
	return p.Like(s.C(sf.getField(s, condition)), condition.GetValue())
}

// InsensitiveExact ILIKE 操作 不区分大小写，精确比对
// SQL: WHERE name ILIKE 'a';
func (sf StructuredFilter) InsensitiveExact(s *sql.Selector, p *sql.Predicate, condition *storev1.FilterCondition) *sql.Predicate {
	return p.EqualFold(s.C(sf.getField(s, condition)), condition.GetValue())
}
...
func (sf StructuredFilter) Regex(s *sql.Selector, p *sql.Predicate, condition *storev1.FilterCondition) *sql.Predicate {
...
func (sf StructuredFilter) InsensitiveRegex(s *sql.Selector, p *sql.Predicate, condition *storev1.FilterCondition) *sql.Predicate {
	p.Append(func(b *sql.Builder) {
		switch s.Builder.Dialect() {
		case dialect.Postgres:
			b.Ident(s.C(sf.getField(s, condition))).WriteString(" ~* ")
...
// Search 全文搜索
// SQL:
func (sf StructuredFilter) Search(s *sql.Selector, p *sql.Predicate, condition *storev1.FilterCondition) *sql.Predicate {
...
func (sf StructuredFilter) DatePart(s *sql.Selector, p *sql.Predicate, condition *storev1.FilterCondition) *sql.Predicate {
...
// DatePartField 日期
func (sf StructuredFilter) DatePartField(s *sql.Selector, condition *storev1.FilterCondition) string {
	if condition.DatePart == nil {
		// 非法的 datePart，不生成表达式以避免注入
		return ""
	}
...
func (sf StructuredFilter) Jsonb(s *sql.Selector, p *sql.Predicate, condition *storev1.FilterCondition) *sql.Predicate {
	if condition.GetJsonPath() == "" {
		return p
	}
...
func (sf StructuredFilter) JsonbFieldExpr(s *sql.Selector, condition *storev1.FilterCondition) *sql.Predicate {
	p := sql.P()
...
// JsonbField JSONB字段
func (sf StructuredFilter) JsonbField(s *sql.Selector, condition *storev1.FilterCondition) string {
	p := sql.P()
