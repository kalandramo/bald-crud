...
```bash
go get github.com/kalandramo/bald-crud/entgo
```
...
```go
import "github.com/kalandramo/bald/bconf/gen/go/pagination/v1"
...
```go
import "github.com/kalandramo/bald-crud/entgo/mixin"
...
```go
import "github.com/kalandramo/bald-crud/entgo/interceptor"
