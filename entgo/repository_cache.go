...
func (r *Repository[
	...
	ENT_DELETE,
	PREDICATE, DTO, ENTITY,
]) generateListCacheKey(vc viewer.Context, req *storev1.PagingRequest) (string, error) {
	if req == nil {
...
func (r *Repository[
	...
	ENT_DELETE,
	PREDICATE, DTO, ENTITY,
]) generateListCacheKeyFromPagination(vc viewer.Context, req *storev1.PaginationRequest) (string, error) {
	if req == nil {
