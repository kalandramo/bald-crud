...
import (
	...
	"github.com/kalandramo/bald-crud/clickhouse/field"
	"github.com/kalandramo/bald-crud/clickhouse/filter"
	paging "github.com/kalandramo/bald-crud/clickhouse/pagination"
	"github.com/kalandramo/bald-crud/clickhouse/query"
	"github.com/kalandramo/bald-crud/clickhouse/sorting"
...
func (r *Repository[DTO, ENTITY]) ListWithPaging(ctx context.Context, req *storev1.PagingRequest) (*PagingResult[DTO], error) {
	if r.client == nil {
...
func (r *Repository[DTO, ENTITY]) ListWithPagination(ctx context.Context, req *storev1.PaginationRequest) (*PagingResult[DTO], error) {
	if r.client == nil {
		return nil, errors.New("clickhouse client is nil")
	}
	if r.table == "" {
