...
func (sf StructuredFilter) BuildSelectors(builder *query.Builder, expr *storev1.FilterExpr) (*query.Builder, error) {
	...
	var buildParts func(e *storev1.FilterExpr) bsonV2.M
	buildParts = func(e *storev1.FilterExpr) bsonV2.M {
		if e == nil {
			return nil
		}
		switch e.GetType() {
...
func (sf StructuredFilter) buildCond(cond *storev1.FilterCondition) bsonV2.M {
	if cond == nil {
		return nil
	}
	field := cond.GetField()
