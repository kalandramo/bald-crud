...
func TestStructuredSorting_BuildOrderClause_Orderings(t *testing.T) {
	...
	orders := []*storev1.Sorting{
		{Field: "name", Direction: storev1.Sorting_ASC},
		{Field: "age", Direction: storev1.Sorting_DESC},
		nil,
		{Field: "", Direction: storev1.Sorting_ASC},
		{Field: "UserProfile.name", Direction: storev1.Sorting_ASC}, // first segment -> snake_case
		{Field: "created_at", Direction: storev1.Sorting_ASC},
	}
...
func TestStructuredSorting_BuildOrderClauseWithDefaultField(t *testing.T) {
	...
	gotBuilder2 := ss.BuildOrderClauseWithDefaultField(qb2, []*storev1.Sorting{{Field: "score", Direction: storev1.Sorting_DESC}}, "created_at", true)
