...
```bash
go get github.com/kalandramo/bald-crud/mongodb
```
...
filterExpr := &storev1.FilterExpr{
    Conditions: []*storev1.FilterCondition{
        {
            Field: "age",
            Op:    storev1.Operator_GT,
            Value: &storev1.FilterCondition_ValueOneof{Value: "18"},
        },
    },
}
...
sorting := []*storev1.Sorting{
    {Field: "created_at", Direction: storev1.Sorting_DESC},
}
