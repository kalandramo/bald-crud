...
```bash
go get github.com/kalandramo/bald-crud/pagination
```
...
```go
import "github.com/kalandramo/bald-crud/pagination/paginator"
...
import "github.com/kalandramo/bald-crud/pagination/filter"
...
```go
import "github.com/kalandramo/bald-crud/pagination/sorting"
...
```go
import "github.com/kalandramo/bald-crud/pagination"
...
expr := &storev1.FilterExpr{
    Conditions: []*storev1.FilterCondition{
        {Field: "user_id", Op: storev1.Operator_EQ, Value: ...},
        {Field: "password", Op: storev1.Operator_EQ, Value: ...}, // 敏感字段
    },
}
...
```go
import "github.com/kalandramo/bald-crud/gorm"
...
```go
import "github.com/kalandramo/bald-crud/entgo"
...
```go
import "github.com/kalandramo/bald-crud/mongodb"
...
```go
import "github.com/kalandramo/bald-crud/clickhouse"
...
```go
import "github.com/kalandramo/bald-crud/doris"
