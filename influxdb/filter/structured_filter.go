...
func (sf StructuredFilter) BuildSelectors(builder *query.Builder, expr *storev1.FilterExpr) (*query.Builder, error) {
	...
	processCond := func(b *query.Builder, cond *storev1.FilterCondition) bool {
		if cond == nil {
			return false
		}
		field := cond.GetField()
	...
	// 递归处理表达式
	var walk func(b *query.Builder, e *storev1.FilterExpr) bool
	walk = func(b *query.Builder, e *storev1.FilterExpr) bool {
		if e == nil {
			return false
		}
		switch e.GetType() {
