...
func TestProcessor_ProcessDispatcher(t *testing.T) {
	...
	cases := []struct {
		...
		{storev1.Operator_EQ, "name", "tom", []string{"name", "="}},
		{storev1.Operator_IN, "name", `["a","b"]`, []string{" in "}},
		{storev1.Operator_BETWEEN, "created_at", `["2020-01-01","2021-01-01"]`, []string{">=", "<="}},
		{storev1.Operator_IS_NULL, "deleted_at", "", []string{"is null"}},
		{storev1.Operator_SEARCH, "title", "query", []string{"like"}},
	}
