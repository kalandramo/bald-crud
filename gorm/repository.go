...
import (
	...
	paging "github.com/kalandramo/bald-crud/gorm/pagination"
	"github.com/kalandramo/bald-crud/gorm/sorting"
...
func (r *Repository[DTO, ENTITY]) ListWithPaging(ctx context.Context, db *gorm.DB, req *storev1.PagingRequest) (*PagingResult[DTO], error) {
	if req == nil {
...
func (r *Repository[DTO, ENTITY]) ListWithPagination(ctx context.Context, db *gorm.DB, req *storev1.PaginationRequest) (*PagingResult[DTO], error) {
	if req == nil {
