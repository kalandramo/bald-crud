...
func (ss StructuredSorting) BuildScope(orders []*storev1.Sorting) func(*gorm.DB) *gorm.DB {
...
func (ss StructuredSorting) BuildScopeWithDefaultField(orders []*storev1.Sorting, defaultOrderField string, defaultDesc bool) func(*gorm.DB) *gorm.DB {
