...
func (p *Processor) BuildOpenSearchQuery(expr *storev1.FilterExpr) map[string]any {
	if expr == nil {
		return nil
	}
	var buildParts func(e *storev1.FilterExpr) map[string]any
	buildParts = func(e *storev1.FilterExpr) map[string]any {
		if e == nil {
			return nil
		}
		switch e.GetType() {
...
func (p *Processor) buildCond(cond *storev1.FilterCondition) map[string]any {
	if cond == nil {
		return nil
	}
	field := cond.GetField()
