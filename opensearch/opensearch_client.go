...
import (
	...
	paging "github.com/kalandramo/bald-crud/opensearch/pagination"
	"github.com/kalandramo/bald-crud/opensearch/query"
	"github.com/kalandramo/bald-crud/opensearch/sorting"
)
...
// req: 分页请求参数
func (c *Client) QueryWithSQLPagination(ctx context.Context, indexName string, req *storev1.PagingRequest) (*SQLResult, error) {
	if req == nil {
		return nil, ErrInvalidRequest
	}
...
func (c *Client) QueryWithSQLPaginationTo(ctx context.Context, indexName string, req *storev1.PagingRequest, out any) error {
